...
-- V0.4.7 keeps a weak side-cache of useful bit lengths for buffers produced by
...
function NanoFormat.fromString(value: string, suffixType: string?): buffer
	-- V0.4.7 keeps the dispatch-before-tonumber parser. Symbolic forms, suffixes, and
